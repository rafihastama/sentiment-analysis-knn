...
function TableLabelingTesting({ data, itemsPerPage, title }) {
    ...
    try {
        const response = await axios.post('http://localhost:5000/label-sentiment-testing', {
            tweet_id: tweetId,
...
export default TableLabelingTesting;
